...
You can install latest version of JLLify from [GitHub](https://github.com/) with:
...
```
## Applying the dataviz color palette
The `scale_color_jll` and `scale_fill_jll` functions have different palette options. You can manually specify these, or use the default 'data_viz' palette. 
